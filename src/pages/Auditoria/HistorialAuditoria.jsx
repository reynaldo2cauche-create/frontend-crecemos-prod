...
const MODULOS = [
  ...
  { value: 'BLOQUEOS', label: 'Bloqueos de Horario' },
...
const ACCIONES = [
  ...
  { value: 'CREAR_BLOQUEO', label: 'Crear Bloqueo' },
  { value: 'EDITAR_BLOQUEO', label: 'Editar Bloqueo' },
  { value: 'ELIMINAR_BLOQUEO', label: 'Eliminar Bloqueo' },
  { value: 'REGISTRAR_VENTA_SERVICIO', label: 'Registrar Venta Servicio' },
  { value: 'ACTUALIZAR_VENTA_SERVICIO', label: 'Editar Venta Servicio' },
  { value: 'ELIMINAR_VENTA_SERVICIO', label: 'Eliminar Venta Servicio' },
  { value: 'REGISTRAR_VENTA_PRODUCTO', label: 'Registrar Venta Producto' },
  { value: 'ACTUALIZAR_VENTA_PRODUCTO', label: 'Editar Venta Producto' },
  { value: 'ELIMINAR_VENTA_PRODUCTO', label: 'Eliminar Venta Producto' },
  { value: 'VALIDAR_PAGO_VENTA', label: 'Validar Pago de Venta' },
...
const HistorialAuditoria = () => {
  ...
  const getColorModulo = (modulo) => {
    const colores = {
      ...
      BLOQUEOS: { bg: 'bg-rose-100', text: 'text-rose-700', dot: 'bg-rose-500', border: 'border-rose-200' },
      VENTAS: { bg: 'bg-amber-100', text: 'text-amber-700', dot: 'bg-amber-500', border: 'border-amber-200' },
