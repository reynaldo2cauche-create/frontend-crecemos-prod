  ...
  return (
    <>
      ...
      <div className="text-center p-5" style={{ backgroundColor: '#f8f9fa', borderRadius: '12px' }} data-aos="fade-up">
        <h3 className="mb-3">¿Te preocupa el bienestar emocional de tu hijo?</h3>
        <p className="mb-4">
          En Centro Crecemos contamos con profesionales en psicología infantil que pueden orientarte y
          acompañar el desarrollo de tu hijo.
        </p>
