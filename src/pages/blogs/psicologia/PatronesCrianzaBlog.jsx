...
export default function PatronesCrianzaBlog() {
  return (
    <>
      ...
      {/* IMAGEN 1 - PORTADA */}
      {/* PROMPT: "Ilustración emocional mostrando una cadena rota en el centro, con una familia
          moderna abrazándose al fondo. Tonos cálidos: naranjas, amarillos y rosas suaves.
          Ambiente esperanzador y de transformación. Luz cálida que simboliza un nuevo comienzo.
          Estilo ilustración digital profesional, minimalista y emotivo." */}
      <div className="recipe-image-placeholder mb-5" data-aos="fade-up">
        <img
          src="/assets/img/blog/crianza-portada.jpg"
          alt="Romper el círculo: patrones de crianza"
      ...
      <h2 className="section-title" data-aos="fade-up">¿Qué Patrones Seguimos Repitiendo Sin Darnos Cuenta?</h2>
      ...
      <div className="table-responsive mb-5" data-aos="fade-up">
        <table className="table table-bordered table-hover">
          ...
          <tbody>
            <tr>
              <td><strong>El Amor Condicional</strong></td>
              <td>
                La aceptación, el cariño o la atención se otorgan o se retiran en función del
                comportamiento del niño. <em>"Si te portas bien, te quiero/te presto atención."</em>
              </td>
            </tr>
            <tr>
              <td><strong>La Culpa y la Vergüenza</strong></td>
              <td>
                Se recurre a frases o actitudes que buscan la obediencia generando culpa o vergüenza.
                Ejemplo: <em>"Me pones muy triste con tu comportamiento"</em>, o
                <em>"Mira qué vergüenza, todos nos están viendo"</em>.
              </td>
            </tr>
            <tr>
              <td><strong>La Regulación Emocional Ausente</strong></td>
              <td>
                Se ignoran, invalidan o minimizan las emociones del niño (<em>"No es para tanto"</em>,
                <em>"Deja de llorar"</em>), enseñándole que sus sentimientos no son seguros o válidos.
              </td>
            </tr>
            <tr>
              <td><strong>El Control Excesivo</strong></td>
              <td>
            ...
            <tr>
              <td><strong>La Amenaza Velada</strong></td>
              <td>
                Aunque no es un grito, es una advertencia de consecuencias no deseadas que generan ansiedad.
                Ejemplo: <em>"Si no recoges tus juguetes, no podremos ir al parque, y será tu culpa."</em>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <h2 className="section-title" data-aos="fade-up">¿Qué Realmente Hacer Para Ser Una Generación Que Genere el Cambio?</h2>
      ...
      <div className="table-responsive mb-5" data-aos="fade-up">
        <table className="table table-bordered table-hover">
          <thead className="table-light">
            <tr>
              <th>Estilo de Crianza</th>
              <th>Nivel de Afecto y Apoyo</th>
              <th>Nivel de Exigencia y Límites</th>
              <th>Consecuencias en el Niño</th>
              <th>¿Cómo suena este estilo?</th>
            </tr>
          </thead>
          <tbody>
            <tr style={{ backgroundColor: '#d4edda' }}>
              <td><strong>1. Democrático (Autorizativo)</strong></td>
              <td>ALTO (Cariñoso, sensible a las necesidades del niño)</td>
              <td>ALTO (Límites claros y firmes, consistentes)</td>
              <td>Niños seguros de sí mismos, con buena autoestima, autonomía y habilidad para resolver problemas.</td>
              <td><em>"Entiendo que estés molesto por el límite, pero la regla es clara y la vamos a cumplir.
              Hablemos de cómo te sientes y busquemos soluciones."</em></td>
            </tr>
            <tr style={{ backgroundColor: '#f8d7da' }}>
              <td><strong>2. Autoritario</strong></td>
              <td>BAJO (Distante, solo se enfoca en la disciplina)</td>
              <td>ALTO (Reglas rígidas, no se explican ni se negocian)</td>
              <td>Niños obedientes, pero inseguros, con baja iniciativa y dependencia de la aprobación ajena.</td>
              <td><em>"No me interesa tu opinión. Lo haces porque yo lo digo y punto. No hay discusión."</em></td>
            </tr>
            <tr style={{ backgroundColor: '#fff3cd' }}>
              <td><strong>3. Permisivo (Indulgente)</strong></td>
              <td>ALTO (Complaciente, intenta evitar el conflicto)</td>
              <td>BAJO (Límites inconsistentes o inexistentes)</td>
              <td>Niños impulsivos, con baja tolerancia a la frustración y dificultad para seguir normas.</td>
              <td><em>"Ay, no te preocupes por el desorden, ya lo recojo yo. Lo importante es que estés tranquilo."</em></td>
            </tr>
            <tr style={{ backgroundColor: '#e2e3e5' }}>
              <td><strong>4. Negligente (Ausente)</strong></td>
              <td>BAJO (Desconectado, indiferente a la vida del niño)</td>
              <td>BAJO (Sin límites ni estructura, poca supervisión)</td>
              <td>Niños inseguros que a menudo buscan afecto y atención fuera del hogar, con baja autoestima.</td>
              <td><em>"No tengo tiempo para esto ahora. Arréglalo tú solo. ¿Ya comiste algo?"</em></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <h3 className="mt-5 mb-4" data-aos="fade-up">Desmontando Mitos Sobre la Crianza Positiva</h3>
      ...
      <div className="table-responsive mb-5" data-aos="fade-up">
        <table className="table table-bordered">
          <thead className="table-light">
            <tr>
              <th style={{ width: '50%', backgroundColor: '#f8d7da' }}>MITO</th>
              <th style={{ width: '50%', backgroundColor: '#d4edda' }}>VERDAD</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td>La Crianza Positiva significa que los niños hacen lo que quieren y no tienen límites.</td>
              <td>La Crianza Positiva se basa en <strong>límites claros y una estructura firme</strong>.
              La diferencia es que los límites se explican y se establecen con respeto, no con temor.
              La Permisividad corresponde al estilo Indulgente, no al Democrático.</td>
            </tr>
            <tr>
              <td>La Crianza Positiva es demasiado blanda y crea adultos malcriados.</td>
              <td>Los niños criados con firmeza y afecto suelen ser <strong>más competentes, independientes
              y desarrollan mejores habilidades sociales</strong>, ya que aprenden a regularse internamente,
              no por miedo a una autoridad externa.</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="row gy-4 mb-5">
        ...
        <div className="col-md-6" data-aos="fade-up" data-aos-delay="200">
          <div className="benefit-card" style={{ borderLeft: '4px solid #2ecc71' }}>
            <div className="benefit-icon">
      ...
      <div className="table-responsive mb-5" data-aos="fade-up">
        <table className="table table-bordered table-hover">
          <thead className="table-light">
            <tr>
              <th>Situación</th>
              <th style={{ backgroundColor: '#d4edda' }}>Intenta decir esto:</th>
              <th style={{ backgroundColor: '#f8d7da' }}>En lugar de esto:</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td><strong>Te faltan al respeto</strong></td>
              <td><em>"No voy a discutir mientras me hables así. Hablamos cuando bajes el tono."</em></td>
              <td><em>"¡A mí no me hablas así o te vas a arrepentir!"</em></td>
            </tr>
            <tr>
              <td><strong>No quieren cooperar</strong></td>
              <td><em>"Necesito tu ayuda con esto. ¿Cómo nos organizamos para que termines rápido?"</em></td>
              <td><em>"¡Hazlo porque yo lo digo y punto!"</em></td>
            </tr>
            <tr>
              <td><strong>Están en plena crisis</strong></td>
              <td><em>"Veo que estás muy enojado. Aquí estoy cerca para cuando estés listo para calmarte."</em></td>
              <td><em>"¡Ya deja de llorar por esa tontería!"</em></td>
            </tr>
          </tbody>
        </table>
      </div>
