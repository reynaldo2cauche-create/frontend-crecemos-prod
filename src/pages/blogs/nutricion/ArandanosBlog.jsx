  ...
  return (
    <>
      <div className="lead mb-5" style={{ fontSize: '1.2rem', lineHeight: '1.8', color: '#555' }}>
        Los arándanos son una fruta pequeña con alto valor nutricional, rica en antioxidantes y
        vitaminas. Pueden incorporarse en la alimentación infantil desde el primer año, adaptando su
        textura para garantizar una ingesta segura y nutritiva.
      </div>
